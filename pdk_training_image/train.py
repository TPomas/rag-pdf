...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=False,
        action=argparse.BooleanOptionalAction,
        help="Pass HUGGING_FACE_HUB_TOKEN value to MLDE experiment",
    )
...
def main():
    ...
    if args.use_hf_token:
        print("Passing HUGGING_FACE_HUB_TOKEN value to MLDE experiment config")
        hf_token_string = "HUGGING_FACE_HUB_TOKEN="+str(os.getenv("HUGGING_FACE_HUB_TOKEN"))
        config["environment"]["environment_variables"] = [hf_token_string]
